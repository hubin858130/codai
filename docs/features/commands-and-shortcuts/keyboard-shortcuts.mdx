...
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`codai.openInNewTab`](/features/commands-and-shortcuts/overview)                        | Opens Cline in a new editor tab               |
| [`codai.addToChat`](/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Cline chat              |
| [`codai.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Cline                 |
| `codai.focusChatInput`                                                                   | Focuses the Cline chat input field            |
| [`codai.generateGitCommitMessage`](/features/commands-and-shortcuts/git-integration)     | Generates a commit message for staged changes |
| [`codai.explainCode`](/features/commands-and-shortcuts/code-commands)                    | Explains selected code                        |
| [`codai.improveCode`](/features/commands-and-shortcuts/code-commands)                    | Suggests improvements for selected code       |
| [`cline.fixWithCline`](/features/commands-and-shortcuts/code-commands)                   | Fixes code with errors                        |
| `codai-top.SidebarProvider.focus`                                                       | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `codai-top.SidebarProvider.focus`        | Opens the Cline sidebar panel |
| New Task              | `Alt+N`                        | `codai.plusButtonClicked`                 | Starts a new Cline task       |
| Add Terminal to Cline | `Alt+T`                        | `codai.addTerminalOutputToChat`           | Adds terminal output to Cline |
