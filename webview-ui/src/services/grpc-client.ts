...
export class BusinessServiceClient extends ProtoBusClient {
	static override serviceName: string = "cline.BusinessService"
    static async setCurrentLanguage(request: proto.cline.SetCurrentLanguageRequest): Promise<proto.cline.Empty> {
		return this.makeUnaryRequest("setCurrentLanguage", request, proto.cline.SetCurrentLanguageRequest.toJSON, proto.cline.Empty.fromJSON)
	}
    static async getCurrentLanguage(request: proto.cline.EmptyRequest): Promise<proto.cline.String> {
		return this.makeUnaryRequest("getCurrentLanguage", request, proto.cline.EmptyRequest.toJSON, proto.cline.String.fromJSON)
	}
    static async setAutoCompletion(request: proto.cline.SetAutoCompletionRequest): Promise<proto.cline.Empty> {
		return this.makeUnaryRequest("setAutoCompletion", request, proto.cline.SetAutoCompletionRequest.toJSON, proto.cline.Empty.fromJSON)
	}
    static async getAutoCompletion(request: proto.cline.EmptyRequest): Promise<proto.cline.AutoCompletionResponse> {
		return this.makeUnaryRequest("getAutoCompletion", request, proto.cline.EmptyRequest.toJSON, proto.cline.AutoCompletionResponse.fromJSON)
	}
    static async enhancePrompts(request: proto.cline.EnhancePromptsRequest): Promise<proto.cline.String> {
		return this.makeUnaryRequest("enhancePrompts", request, proto.cline.EnhancePromptsRequest.toJSON, proto.cline.String.fromJSON)
	}
    static async testAutoCompletion(request: proto.cline.SetAutoCompletionRequest): Promise<proto.cline.TestAutoCompletionResponse> {
		return this.makeUnaryRequest("testAutoCompletion", request, proto.cline.SetAutoCompletionRequest.toJSON, proto.cline.TestAutoCompletionResponse.fromJSON)
	}
}
...
export class CommandsServiceClient extends ProtoBusClient {
    ...
    static async addToCodai(request: proto.cline.CommandContext): Promise<proto.cline.Empty> {
		return this.makeUnaryRequest("addToCodai", request, proto.cline.CommandContext.toJSON, proto.cline.Empty.fromJSON)
	}
    static async fixWithCodai(request: proto.cline.CommandContext): Promise<proto.cline.Empty> {
		return this.makeUnaryRequest("fixWithCodai", request, proto.cline.CommandContext.toJSON, proto.cline.Empty.fromJSON)
	}
    static async explainWithCodai(request: proto.cline.CommandContext): Promise<proto.cline.Empty> {
		return this.makeUnaryRequest("explainWithCodai", request, proto.cline.CommandContext.toJSON, proto.cline.Empty.fromJSON)
	}
    static async improveWithCodai(request: proto.cline.CommandContext): Promise<proto.cline.Empty> {
		return this.makeUnaryRequest("improveWithCodai", request, proto.cline.CommandContext.toJSON, proto.cline.Empty.fromJSON)
	}
}
