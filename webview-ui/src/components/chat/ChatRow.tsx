				...
				case "summarizeTask":
					return (
						<>
							<div style={headerStyle}>
								{toolIcon("book")}
								<span style={{ fontWeight: "bold" }}>Codai is condensing the conversation:</span>
							</div>
							<div
								style={{
									borderRadius: 3,
						...
						return (
							<div
								...
								<div style={{ color: "var(--vscode-foreground)", opacity: 0.8 }}>
									Codai may have trouble viewing the command's output. Please update VSCode (
							...
							<>
								<div style={headerStyle}>
									...
									<span style={{ color: normalColor, fontWeight: "bold" }}>
										Codai wants to start a new task:
									</span>
								</div>
