...
function claude35SonnetLazyApplyPrompt(...args: Parameters<LazyApplyPrompt>): ReturnType<LazyApplyPrompt> {
...
export function lazyApplyPromptForModel(model: string, provider: string): LazyApplyPrompt | undefined {
