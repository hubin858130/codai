...
describe("findInAst", () => {
	...
	it("should return null if no node matches the criterion", () => {
		const mockAst = createMockSyntaxNode("root", [createMockSyntaxNode("child1", []), createMockSyntaxNode("child2", [])])
	...
	it("should find a nested node matching the criterion", () => {
		const mockAst = createMockSyntaxNode("root", [
			createMockSyntaxNode("child1", [createMockSyntaxNode("child2", [createMockSyntaxNode("function", [])])]),
	...
	it("should return the root node if it matches the criterion", () => {
		const mockAst = createMockSyntaxNode("function", [createMockSyntaxNode("child1", []), createMockSyntaxNode("child2", [])])
...
function createMockSyntaxNode(type: string, children: Parser.SyntaxNode[]): Parser.SyntaxNode {
