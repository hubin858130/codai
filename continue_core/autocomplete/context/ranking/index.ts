 ...
 */
function deduplicateSnippets(snippets: Required<AutocompleteSnippetDeprecated>[]): Required<AutocompleteSnippetDeprecated>[] {
	// Group by file
	const fileGroups: {
...
function mergeSnippetsByRange(snippets: Required<AutocompleteSnippetDeprecated>[]): Required<AutocompleteSnippetDeprecated>[] {
