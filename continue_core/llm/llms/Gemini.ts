...
class Gemini extends BaseLLM {
	static override providerName = "gemini"
	...
	public prepareBody(messages: ChatMessage[], options: CompletionOptions, isV1API: boolean): GeminiChatRequestBody {
	...
	public async *processGeminiResponse(stream: AsyncIterable<string>): AsyncGenerator<ChatMessage> {
		let buffer = ""
	...
	override async _embed(batch: string[]): Promise<number[][]> {
