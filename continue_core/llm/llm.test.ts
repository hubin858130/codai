...
describe("LLM", () => {
	...
	testLLM(new OpenAI({ apiKey: process.env.OPENAI_API_KEY, model: "o1-preview" }), { skip: false, timeout: 60000 })
	...
	testLLM(
		new Azure({
			...
			model: "codestral-latest",
			apiBase: "https://codestral-2501-continue-testing.eastus.models.ai.azure.com",
