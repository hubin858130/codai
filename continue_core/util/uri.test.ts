...
describe("uri utils", () => {
	...
	describe("findUriInDirs", () => {
		const dirUris = ["file:///workspace/project1", "file:///workspace/project2"]
	...
	describe("joinPathsToUri", () => {
		...
		it("should handle paths with special characters", () => {
			expect(joinPathsToUri("file:///base", "path with spaces", "file.txt")).toBe(
				"file:///base/path%20with%20spaces/file.txt",
			)
		})
	})
