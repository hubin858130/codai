...
describe("GlobalContext", () => {
	...
	it("should handle JSON parsing errors gracefully on get", () => {
		...
		const value = globalContext.get("indexingPaused")
		expect(value).toBeUndefined()
		expect(consoleWarnMock).toHaveBeenCalledWith(expect.stringContaining("Error parsing global context"))
	...
	it("should handle JSON parsing errors gracefully on update", () => {
		...
		expect(consoleWarnMock).toHaveBeenCalledWith(expect.stringContaining("Error updating global context"))
