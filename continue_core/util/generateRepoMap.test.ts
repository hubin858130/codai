...
describe.skip("generateRepoMap", () => {
	...
	it("should generate a repo map with signatures included", async () => {
		...
		jest.spyOn(CodeSnippetsCodebaseIndex, "getPathsAndSignatures").mockImplementation(async (dirs, offset, limit) => {
			// Return test data
			return {
				groupedByUri: {
					[path.join(TEST_DIR, "file1.js")]: ["function foo() {}", "function bar() {}"],
					[path.join(TEST_DIR, "subdir/file2.py")]: ["def foo():", "def bar():"],
				},
	...
	it("should handle file read errors gracefully", async () => {
		...
		jest.spyOn(fs.promises, "readFile").mockImplementation((filePath, encoding) => {
