...
function safeParseArray<T>(value: string, errorMessage: string = "Error parsing array"): T[] | undefined {
	try {
...
class HistoryManager {
	...
	delete(sessionId: string) {
		...
		let sessionsList = safeParseArray<SessionMetadata>(sessionsListRaw, "Error parsing sessions.json") ?? []
