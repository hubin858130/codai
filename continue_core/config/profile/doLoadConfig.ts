...
import { ContinueConfig, ContinueRcJson, IDE, IdeSettings, ILLMLogger, SerializedContinueConfig, Tool } from "../../"
...
async function injectControlPlaneProxyInfo(config: ContinueConfig, info: ControlPlaneProxyInfo): Promise<ContinueConfig> {
