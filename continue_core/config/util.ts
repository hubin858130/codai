...
import { ContinueConfig, ExperimentalModelRoles, IDE, ILLM, ModelDescription } from "../"
...
export function getModelByRole<T extends keyof ExperimentalModelRoles>(config: ContinueConfig, role: T): ILLM | undefined {
