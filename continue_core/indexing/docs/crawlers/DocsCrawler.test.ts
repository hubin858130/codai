...
import DocsCrawler, { ChromiumInstaller, DocsCrawlerType, type PageData } from "./DocsCrawler"
...
describe("DocsCrawler", () => {
	...
	describe.skip("Chromium Crawler", () => {
		...
		beforeAll(async () => {
			...
			shouldUseChromiumSpy = jest.spyOn(docsCrawler as any, "shouldUseChromium").mockReturnValue(true)
		}, TIMEOUT_MS)
