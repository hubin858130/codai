...
function breakdownArticleComponent(url: string, article: ArticleComponent, subpath: string, max_chunk_size: number): Chunk[] {
	const chunks: Chunk[] = []
...
export async function htmlPageToArticleWithChunks(page: PageData, maxChunkSize: number): Promise<ArticleWithChunks | undefined> {
	try {
