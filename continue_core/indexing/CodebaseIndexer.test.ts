...
describe("CodebaseIndexer", () => {
	...
	const codebaseIndexer = new TestCodebaseIndexer(testConfigHandler, testIde, pauseToken, continueServerClient)
	...
	async function expectPlan(compute: number, addTag: number, removeTag: number, del: number) {
