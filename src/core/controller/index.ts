...
//huqb
import { getAutocompleteConfig, updateAutocompleteConfig, getLanguageConfig, updateLanguageConfig } from "@continuedev/core/util/codaiConfigUtil"
	...
	async handleWebviewMessage(message: WebviewMessage) {
		switch (message.type) {
			...
			case "updateSettings": {
				...
				// autocomplete config
				if (message.autocompleteConfig) {//huqb
			...
			case "getAutocompleteConfig": {//huqb
