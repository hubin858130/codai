...
- Use "${mcpDetails.mcpId}" as the server name in codai_mcp_settings.json.
- Create the directory for the new MCP server before starting installation.
- Make sure you read the user's existing codai_mcp_settings.json file before editing it with this new mcp, to not overwrite any existing servers.
...
Here is the project's README to help you get started:\n\n${mcpDetails.readmeContent}\n${mcpDetails.llmsInstallationContent}`
	...
	async fixWithCodai(code: string, filePath: string, languageId: string, diagnostics: vscode.Diagnostic[]) {
		// Ensure the sidebar view is visible
		await vscode.commands.executeCommand("codai-top.SidebarProvider.focus")
		await setTimeoutPromise(100)
		...
		console.log("fixWithCodai", code, filePath, languageId, diagnostics, problemsString)
	}
